...
const progressText = document.getElementById('score');
const scoreText = document.getElementById ('progressBarFull');
...
let questions = [
    {
        ...
        choice2: "a reference to ,ultiple variable",
    ...
    },
    {
        ...
        choice3: "Java app are run virtual machine or web browser JS is run on a web browser",
